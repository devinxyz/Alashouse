        ...
        <div class="widget-box span12">
          ...
          <div class="widget-content">
            <div class="alert alert-info alert-block">
              ...
              Silahkan tunggu pesanan tiba di meja saudara.<br> Apabila telah selesai, silahkan lakukan proses pembayaran di kasir !
              <h5 class="font-weight-bold">Jika ada tambahan pesanan langsung ke kasir :)</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="span12">
        ...
        <div class="widget-box span12">
          <div class="widget-title bg_lg"><span class="icon"><i class="icon-th-large"></i></span>
            <h5>Daftar Menu</h5>
            <a href="#keranjang" class="btn btn-warning btn-mini label"><i class='icon-shopping-cart'> </i>Keranjang</a>
          </div>
          <div class="widget-content" >
            <ul class="thumbnails">
...
<div class="row-fluid fixed-bottom" style="background-color: #212529;">
