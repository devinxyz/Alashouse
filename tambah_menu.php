            ...
            <div class="control-group">
              ...
              <div class="controls">
                <?php 
                  if(isset($_SESSION['edit_menu'])){
                ?>
                  <input name="" type="text" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Menu" disabled=""/>
                  <input name="nama_masakan" type="hidden" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Masakan"/>
                <?php
                  } else {
                ?>
                  <input name="nama_masakan" type="text" value="" class="span11" placeholder="Nama Menu"/>
                <?php
                  }
                ?>
              </div>
